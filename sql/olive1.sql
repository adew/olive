...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2022 at 04:33 AM
...
(7, '01-K/PM III-18/AD/VI/2021', 'Mayor/0293029392023', 'SETYA PRAHARA', '2020-07-29', 'ad', '01-KPM_III-18ADVI2021_642.docx', 1625926542),
...
(12, '02-K/', 'sdfasdf', 'jaya sdfds', '2021-10-13', 'ad', '02-K_462.docx', 1634082211);
...
(7, 2021, 7, 'kejahatan', '1', 7, 3, 1633990679),
...
(75, 2021, 7, 'kejahatan', '3', 0, 1, 1633990739);
...
(1, '127.0.0.1', 'jaya', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'dd@aada', '', NULL, NULL, 'cScBG4T//RsE1fXjZi9q6O', 1268889823, 1644797292, 1, 'Jaya Sentosa', '', '', NULL, NULL),
...
--
ALTER TABLE `konsep`
  MODIFY `id_konsep` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
