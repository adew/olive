...
<body>
  <div class="row bg-red">
    <div class="col-md-12 text-center text-white">
      <h2 id="header-text"><b>APLIKASI PENGARSIPAN SURAT UNIT KEPEGAWAIAN</b></h2>
      <h2 style="font-family: 'Courier New', Courier, monospace;"><b>PENGADILAN NEGERI JENEPONTO </b></h2>
  ...
  <div class="container">
    <div id="login-box">
      <div class="text-center">
        ...
        <h2 class="form-signin-heading"><b><span class="text-red">&nbsp;</span></b></h2>
  ...
  <footer class="text-center">
    <div class="container">
      <span class="text-muted" style="text-decoration: none;">
        Copyright &copy; 2021 | Developed By <a href="https://www.instagram.com/adew77_/" target="_blank">adew77_</a>
      </span>
    </div>
  </footer>
