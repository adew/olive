                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="tgl_terima" id="inputTglSurat" class="form-control date-surat" />
                                            <div class="input-group-addon">
...
<script>
    ...
    function editSuratMasuk(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/surat_masuk_byid/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function showModal(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#tglTerima').text(data.tgl_terima);
                ...
                $("a#berkasSurat").attr("href", "<?php echo base_url('uploads/masuk/') ?>" + data.berkas_surat);
